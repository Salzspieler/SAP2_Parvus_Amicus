...
public class Player : MonoBehaviour
{
    ...
    [SerializeField] private AudioClip AtmenSound;
    ...
    void Update()
    {
        ...
        if (isGrounded && !animator.GetBool("HasAphid"))
        {
            ...
            SoundManager.instance.PlaySound(AtmenSound);
        }
        ...
        //hover
        if (!isGrounded && rb.velocity.y <= 0 && animator.GetBool("HasAphid") && Input.GetKey(KeyCode.LeftControl))
        {
